...
class CommandPalette {
    ...
    [void] Render([HybridRenderEngine]$engine) {
        ...
        try {
            ...
            # Filter input
            $filterY = $y + 2
            $engine.WriteAt($x + 2, $filterY, ">", [Colors]::Accent, [Colors]::PanelBg)
            ...
            $engine.WriteAt($cursorX, $filterY, "_", [Colors]::Accent, [Colors]::PanelBg)
            ...
            if ($count -eq 0) {
                ...
                for ($i = 0; $i -lt $listH; $i++) {
                    ...
                    $engine.WriteAt($x + 2, $listY + $i, $keyStr, [Colors]::Accent, $bg)
